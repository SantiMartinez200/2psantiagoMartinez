...
-- Volcando datos para la tabla sistemaasistencia.alumno: ~24 rows (aproximadamente)
DELETE FROM `alumno`;
INSERT INTO `alumno` (`dni`, `nombre`, `apellido`, `fecha_nacimiento`) VALUES
	(1, 'FELIZ', 'CUMPLE', '2000-11-09'),
...
-- Volcando datos para la tabla sistemaasistencia.asistencia: ~69 rows (aproximadamente)
...
INSERT INTO `asistencia` (`id`, `dni`, `fecha_asistencia`) VALUES
	...
	(95, 40018598, '2023-10-28 23:52:58'),
	(96, 38570361, '2023-10-28 23:53:01'),
	(97, 43414566, '2023-10-28 23:53:04'),
...
INSERT INTO `parametros` (`clave_ajuste`, `dias_clases`, `promedio_promocion`, `promedio_regularidad`, `edad_minima`, `tolerancia`, `horario_fijo`) VALUES
	(1, 24, 80, 60, 17, '00:15:00', '19:30:00');
