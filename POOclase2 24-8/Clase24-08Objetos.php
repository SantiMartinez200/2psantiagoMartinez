...
//LISTADO DE TAREAS
//1-) Crear al menos DOS instancias de la clase PERSONA. y DOS instancias o mas de la clase CUENTA BANCARIA.
//2-) Crear UNA instancia de la clase BANCO y agregar las cuentasBancarias a la lista del banco.
...
$cuenta1 = new cuentaBancaria("0001", $persona1, 0);
$cuenta2 = new cuentaBancaria("0002", $persona2, 0);
print_r($cuenta1);
echo ("<br>");
var_dump($cuenta2);
